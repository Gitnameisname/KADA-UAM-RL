...
class TiltrotorTransitionTraining(gym.Env):
    ...
    def step(self, action):
        ...
        # if self.action[action_in] == "dddd":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "dddm":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "ddmd":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "ddmm":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "ddid":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "ddim":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "dmdd":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "dmdm":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "dmmd":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "dmmm":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "dmid":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "dmim":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "didd":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "didm":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "dimd":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "dimm":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "diid":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "diim":
        #     self.f_rpm   -=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "mddd":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "mddm":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "mdmd":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "mdmm":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "mdid":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "mdim":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "mmdd":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "mmdm":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "mmmd":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "mmmm":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "mmid":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "mmim":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "midd":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "midm":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "mimd":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "mimm":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "miid":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "miim":
        #     self.f_rpm   -=   self.rpm_rate*0
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "iddd":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "iddm":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "idmd":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "idmm":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "idid":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "idim":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "imdd":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "imdm":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "immd":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "immm":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "imid":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "imim":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   -=   self.rpm_rate*0
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "iidd":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "iidm":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "iimd":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "iimm":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    -=   self.elev_rate*0
        #     self.tilt    -=   self.tilt_rate*0
        # elif self.action[action_in] == "iiid":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate
        # elif self.action[action_in] == "iiim":
        #     self.f_rpm   +=   self.rpm_rate
        #     self.r_rpm   +=   self.rpm_rate
        #     self.elev    +=   self.elev_rate
        #     self.tilt    -=   self.tilt_rate*0
        ...
        # Calc reward
        # reward = math.sqrt(self.state[1]**2 + self.state[2]**2)/100 + (1-self.action[2])**2
        # reward = math.sqrt((1 - self.action[2])**2 + ((self.state[3])/15)**2  + (self.state[1])**2 - (abs(self.state[2]*180/math.pi)/360)**2)
        # reward = self.current_score + math.sqrt((1 - self.tilt)**2 + (self.state[3]/15)**2 + (self.state[1])**2)
        # reward = self.current_score + (self.state[6])
        # State
        # [X, Z, theta, U, W, q, time]
        # [0, 1,     2, 3, 4, 5,    6]
        # Action
        ...
        pitch_error = abs(self.state[2])*180/math.pi
        alt_error = self.state[1]

        # self.current_score = (self.state[6]) + math.sqrt((1 - self.tilt)**2 + (self.state[1])**2) + (self.state[3])

        condition_1 = 90-self.tilt
        # 조건 1(tilt각이 0도가 될 경우)

        condition_2 = np.exp(-1.0 * pitch_error)
        # if pitch_error <=15 :
        #     condition_3 = 1
        # else:
        #     condition_3 = 0.01
        ...
        condition_5 = np.exp(-1.0 * self.state[1])
        # 조건 5(고도 차이 절대값 최소화)

        # [Tilt, Pitch, Time, Speed, Altitude]
        if self.state[3] < 20:
            weight = [0,500,10,1000,0]
        else:
            weight = [500,100,10,20,0]
        #if self.state[3] < 17:
        #    weight = [8,1,5,3,0,10,0] # 가중치
        #else:
        #    weight = [5,10,7,3,0,7,0] # 가중치

        condition_sum = [condition_1, condition_2, condition_3, condition_4, condition_5]
        reward = np.dot(weight, condition_sum)

        # weight = [5, 10, 6, 4, 9, 7, 8]  # Current weights

        # Assigning priority to reward elements for stable tilting
        # priority = [4, 1, 2, 3, 7, 5, 6]  # Adjust the order of the elements based on priority

        # Create a list of tuples containing the weight and priority pairs
        # weight_priority = list(zip(weight, priority))

        # # Sort the weight_priority list based on priority in ascending order
        # weight_priority_sorted = sorted(weight_priority, key=lambda x: x[1])

        # # Extract the sorted weights
        # weight_sorted = [item[0] for item in weight_priority_sorted]

        # # Normalize the weights to ensure their sum is 1
        # weight_sum = sum(weight_sorted)
        # weight_normalized = [w / weight_sum for w in weight_sorted]

        # # Use the normalized weights for reward calculation
        # condition_sum = [condition_1, condition_2, condition_3, condition_4, condition_5, condition_6, condition_7]
        # reward = np.dot(weight_normalized, condition_sum)
        ...
        if (np.abs(alt_error)  >= alt_constrain):
            done = True
        if (np.abs(pitch_error)  >= pitch_constrain):
            done = True
        
        #if (self.f_rpm < 0 or self.f_rpm > 1):
        #    done = True
        #if (self.r_rpm < 0 or self.r_rpm > 1):
        #    done = True
        #if (self.elev < -30 or self.elev > 30): #23
        #    done = True
    ...
    def Simulation(self):
        ...
        # =============== Control Allocation ===============
        # self.Throttle_cmd = action[0]                           # 0 ~ 1
        # self.Pitch_cmd = (action[1] - 0.5)*2                    # 0 ~ 1 -> -1 ~ 1
        # self.Tilt_cmd = action[2]*self.tilt_max                 # 0 ~ 1 -> 0 ~ math.pi
        
        # if (self.Tilt_cmd == math.pi/2):
        #     self.f_rpm = self.rpm_max*(self.Throttle_cmd/2 + self.Pitch_cmd/(2*self.f_Lx))
        #     self.r_rpm = self.rpm_max*(self.Throttle_cmd/2 - self.Pitch_cmd/(2*self.r_Lx))
        # else:
        #     self.f_rpm = self.rpm_max*(self.Throttle_cmd/(2*math.cos(self.Tilt_cmd)) + self.Pitch_cmd/(2*self.f_Lx*math.sin(self.Tilt_cmd)))
        #     self.r_rpm = self.rpm_max*(self.Throttle_cmd/2 - self.Pitch_cmd/(2*self.r_Lx))
        
        # if self.f_rpm >= self.rpm_max:
        #     self.f_rpm = self.rpm_max
        # if self.f_rpm <= 0.0:
        #     self.f_rpm = 0.0
        
        # if self.r_rpm >= self.rpm_max:
        #     self.r_rpm = self.rpm_max
        # if self.r_rpm <= 0.0:
        #     self.r_rpm = 0.0
        
        # self.elev = self.Pitch_cmd*self.elev_max
        # =============== Control Allocation ===============
        
        # self.f_rpm = rpm_f
        # self.r_rpm = self.r_rpm
        # self.elev = elev
        # self.Tilt_cmd = self.tilt * math.pi/180
        
        # Test
        # self.f_rpm = self.rpm_max*0.9
        # self.r_rpm = self.rpm_max*0.9
        # self.tilt = 90
        ...
        # print(self.r_rpm)
        # print("f_rpm")
        # print(self.f_rpm*self.rpm_max)
        # print("r_rpm")
        # print(self.r_rpm*self.rpm_max)
        # print("K_T")
        # print(self.K_T)
        # print("r_rpm")
        # print(self.r_rpm)
        ...
        # print("FxT")
        # print(self.T_f*math.cos(self.tilt * math.pi/180))
        # print("FzT")
        # print(- self.T_f*math.sin(self.tilt * math.pi/180) - self.T_r)
        # print("MyT")
        # print((-self.f_Lz*math.cos(self.tilt * math.pi/180) + self.f_Lx*math.sin(self.tilt * math.pi/180))*self.T_f - self.r_Lx*self.T_r)
        
        # print("vel")
        # print(self.vel)
        # print("alpha")
        # print(self.al*180/math.pi)
        # print("FxA")
        # print(- self.D*math.cos(self.al) - self.L*math.sin(self.al))
        # print("FzA")
        # print(self.D*math.sin(self.al) - self.L*math.cos(self.al))
        # print("MyA")
        # print(self.Mp)
        
        # print("Sigma_Fx")
        # print(-self.m*self.g*math.sin(self.state[2]) + self.T_f*math.cos(self.tilt * math.pi/180) - self.D*math.cos(self.al) - self.L*math.sin(self.al))
        # print("Sigma_Fz")
        # print(self.m*self.g*math.cos(self.state[2]) - self.T_f*math.sin(self.tilt * math.pi/180) - self.T_r + self.D*math.sin(self.al) - self.L*math.cos(self.al))
        # print("Sigma_My")
        # print(((-self.f_Lz*math.cos(self.tilt * math.pi/180) + self.f_Lx*math.sin(self.tilt * math.pi/180))*self.T_f - self.r_Lx*self.T_r + self.Mp))
